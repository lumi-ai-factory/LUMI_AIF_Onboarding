# LUMI AI Factory: Onboarding Materials

Welcome to the official onboarding repository for the **LUMI AI Factory**. 

This documentation is specifically designed as a practical "survival guide" for **industry professionals** (startups, SMEs, and enterprise users) who are stepping into the world of High-Performance Computing (HPC) for the first time. 
...
- **Chapter 8:** Graduation exercise and links to advanced technical primers.
